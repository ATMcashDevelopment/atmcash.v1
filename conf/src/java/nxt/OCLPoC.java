...
final class OCLPoC {
    ...
    private static final int hashesPerEnqueue = Nxt.getIntProperty("ATM.oclHashesPerEnqueue") == 0 ? 1000 : Nxt.getIntProperty("ATM.oclHashesPerEnqueue");
    private static final int memPercent = Nxt.getIntProperty("ATM.oclMemPercent") == 0 ? DEFAULT_MEM_PERCENT : Nxt.getIntProperty("ATM.oclMemPercent");
    ...
    static {
        try {
            boolean autoChoose = Nxt.getBooleanProperty("ATM.oclAuto", true);
            ...
            if(autoChoose) {
                ...
                platformIndex = Nxt.getIntProperty("ATM.oclPlatform");
                deviceIndex = Nxt.getIntProperty("ATM.oclDevice");
            }
