...
public interface Attachment extends Appendix {
    ...
    public final static class ATMMiningRewardRecipientAssignment extends AbstractAttachment {
    	
    	ATMMiningRewardRecipientAssignment(ByteBuffer buffer, byte transactionVersion) {
    		super(buffer, transactionVersion);
    	}
    	
    	ATMMiningRewardRecipientAssignment(JSONObject attachmentData) {
    		super(attachmentData);
    	}
    	
    	public ATMMiningRewardRecipientAssignment() {
    	}
        ...
        @Override
        public TransactionType getTransactionType() {
            return TransactionType.ATMMining.REWARD_RECIPIENT_ASSIGNMENT;
        }
    }
