...
final class BlockchainProcessorImpl implements BlockchainProcessor {
	public static final int BLOCKCACHEMB = Nxt.getIntProperty("atm.blockCacheMB") == 0 ? 40 : Nxt.getIntProperty("blockCacheMB");
	public static boolean oclVerify = Nxt.getBooleanProperty("atm.oclVerify");
	public static final int oclThreshold = Nxt.getIntProperty("atm.oclThreshold") == 0 ? 50 : Nxt.getIntProperty("atm.oclThreshold");
	public static final int oclWaitThreshold = Nxt.getIntProperty("atm.oclWaitThreshold") == 0 ? 2000 : Nxt.getIntProperty("atm.oclWaitThreshold");
