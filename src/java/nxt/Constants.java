...
public final class Constants {
	...
	public static int ATM_DIFF_ADJUST_CHANGE_BLOCK = 2700;
	
	public static long ATM_REWARD_RECIPIENT_ASSIGNMENT_START_BLOCK = 6500;
    public static long ATM_REWARD_RECIPIENT_ASSIGNMENT_WAIT_TIME = 4;
    
    public static long ATM_ESCROW_START_BLOCK = 0; // not sure when these were enabled, but they each do an alias lookup every block if greater than the current height
    public static long ATM_SUBSCRIPTION_START_BLOCK = 0;
    public static int ATM_SUBSCRIPTION_MIN_FREQ = 3600;
    public static int ATM_SUBSCRIPTION_MAX_FREQ = 31536000;
    ...
    public static final long INITIAL_BASE_TARGET = 19325193796L;
    public static final long MAX_BASE_TARGET = 198325193796L;
    ...
    public static final int DIGITAL_GOODS_STORE_BLOCK = 100;
