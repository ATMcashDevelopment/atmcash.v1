...
final class TransactionProcessorImpl implements TransactionProcessor {
    ...
    private static final int rebroadcastAfter = Nxt.getIntProperty("ATM.rebroadcastAfter") != 0 ? Nxt.getIntProperty("ATM.rebroadcastAfter") : 4;
    private static final int rebroadcastEvery = Nxt.getIntProperty("ATM.rebroadcastEvery") != 0 ? Nxt.getIntProperty("ATM.rebroadcastEvery") : 2;
